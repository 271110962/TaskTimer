...
class MainActivity : AppCompatActivity()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //observe the tasktiming change
        viewModel.timing.observe(this, Observer<String> { timing -> current_task.text = if(timing != null){
...
//                removeEditPane(fragment)
                if((fragment is AddEditFragment)&&fragment.isDirty()){
                    showConfirmationDialog(DIALOG_ID_CANCEL_EDIT,getString(R.string.cancelEditDiag_msg),R.string.cancelEditDiag_positive_caption,R.string.cancelEditDiag_negative_caption)
                }else{
                    removeEditPane(fragment)
                }
            }
